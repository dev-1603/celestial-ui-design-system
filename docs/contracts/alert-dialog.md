...
Modal confirmation requiring explicit user decision.

## Scope

Phase 1 (P0) contract for `alert-dialog`. Framework-agnostic semantics only; rendering belongs to adapters.
...
Consume this ComponentSpec via `@celestial-ui/core/specs/alert-dialog`. Do not redefine behavior in React/Vue.
