...
Inline status message for contextual feedback.

## Scope

Phase 1 (P0) contract for `alert`. Framework-agnostic semantics only; rendering belongs to adapters.
...
Consume this ComponentSpec via `@celestial-ui/core/specs/alert`. Do not redefine behavior in React/Vue.
