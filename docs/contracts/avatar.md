...
Phase 1 (P0) contract for `avatar`. Framework-agnostic semantics only; rendering belongs to adapters.
...
Consume this ComponentSpec via `@celestial-ui/core/specs/avatar`. Do not redefine behavior in React/Vue.
