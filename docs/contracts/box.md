...
Generic layout primitive wrapper.

## Scope

Phase 1 (P0) contract for `box`. Framework-agnostic semantics only; rendering belongs to adapters.
...
Consume this ComponentSpec via `@celestial-ui/core/specs/box`. Do not redefine behavior in React/Vue.
