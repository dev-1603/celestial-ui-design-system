...
Hierarchical navigation trail for current location.

## Scope

Phase 1 (P1) contract for `breadcrumb`. Framework-agnostic semantics only; rendering belongs to adapters.
...
Consume this ComponentSpec via `@celestial-ui/core/specs/breadcrumb`. Do not redefine behavior in React/Vue.
