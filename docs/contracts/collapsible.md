...
Single expandable/collapsible content region.

## Scope

Phase 1 (P1) contract for `collapsible`. Framework-agnostic semantics only; rendering belongs to adapters.
...
Consume this ComponentSpec via `@celestial-ui/core/specs/collapsible`. Do not redefine behavior in React/Vue.
