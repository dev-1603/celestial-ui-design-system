...
Contextual action menu on pointer trigger.

## Scope

Phase 1 (P1) contract for `context-menu`. Framework-agnostic semantics only; rendering belongs to adapters.
...
Consume this ComponentSpec via `@celestial-ui/core/specs/context-menu`. Do not redefine behavior in React/Vue.
