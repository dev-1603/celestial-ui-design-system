...
Phase 1 (P1) contract for `date-picker`. Framework-agnostic semantics only; rendering belongs to adapters.
...
Consume this ComponentSpec via `@celestial-ui/core/specs/date-picker`. Do not redefine behavior in React/Vue.
