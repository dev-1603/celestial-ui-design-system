...
Phase 1 (P0) contract for `empty-state`. Framework-agnostic semantics only; rendering belongs to adapters.
...
Consume this ComponentSpec via `@celestial-ui/core/specs/empty-state`. Do not redefine behavior in React/Vue.
