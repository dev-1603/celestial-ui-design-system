...
Phase 1 (P1) contract for `file-upload`. Framework-agnostic semantics only; rendering belongs to adapters.
...
Consume this ComponentSpec via `@celestial-ui/core/specs/file-upload`. Do not redefine behavior in React/Vue.
