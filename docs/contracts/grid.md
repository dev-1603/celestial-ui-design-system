...
Phase 1 (P1) contract for `grid`. Framework-agnostic semantics only; rendering belongs to adapters.
...
Consume this ComponentSpec via `@celestial-ui/core/specs/grid`. Do not redefine behavior in React/Vue.
