...
Phase 1 (P0) contract for `input`. Framework-agnostic semantics only; rendering belongs to adapters.
...
Consume this ComponentSpec via `@celestial-ui/core/specs/input`. Do not redefine behavior in React/Vue.
