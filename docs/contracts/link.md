...
Navigational hyperlink control.

## Scope

Phase 1 (P0) contract for `link`. Framework-agnostic semantics only; rendering belongs to adapters.
...
Consume this ComponentSpec via `@celestial-ui/core/specs/link`. Do not redefine behavior in React/Vue.
