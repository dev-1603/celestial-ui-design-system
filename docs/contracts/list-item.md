...
Phase 1 (P1) contract for `list-item`. Framework-agnostic semantics only; rendering belongs to adapters.
...
Consume this ComponentSpec via `@celestial-ui/core/specs/list-item`. Do not redefine behavior in React/Vue.
