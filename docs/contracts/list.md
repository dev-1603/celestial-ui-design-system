...
Phase 1 (P1) contract for `list`. Framework-agnostic semantics only; rendering belongs to adapters.
...
Consume this ComponentSpec via `@celestial-ui/core/specs/list`. Do not redefine behavior in React/Vue.
