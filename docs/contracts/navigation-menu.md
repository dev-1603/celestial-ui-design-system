...
Phase 1 (P1) contract for `navigation-menu`. Framework-agnostic semantics only; rendering belongs to adapters.
...
Consume this ComponentSpec via `@celestial-ui/core/specs/navigation-menu`. Do not redefine behavior in React/Vue.
