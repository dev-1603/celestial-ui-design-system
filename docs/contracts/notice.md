...
Informational inline notice banner.

## Scope

Phase 1 (P1) contract for `notice`. Framework-agnostic semantics only; rendering belongs to adapters.
...
Consume this ComponentSpec via `@celestial-ui/core/specs/notice`. Do not redefine behavior in React/Vue.
