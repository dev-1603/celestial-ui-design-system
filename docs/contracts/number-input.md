...
Numeric value text input.

## Scope

Phase 1 (P1) contract for `number-input`. Framework-agnostic semantics only; rendering belongs to adapters.
...
Consume this ComponentSpec via `@celestial-ui/core/specs/number-input`. Do not redefine behavior in React/Vue.
