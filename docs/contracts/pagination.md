...
Navigate paged collections of content.

## Scope

Phase 1 (P0) contract for `pagination`. Framework-agnostic semantics only; rendering belongs to adapters.
...
Consume this ComponentSpec via `@celestial-ui/core/specs/pagination`. Do not redefine behavior in React/Vue.
