...
Masked password entry control.

## Scope

Phase 1 (P1) contract for `password-input`. Framework-agnostic semantics only; rendering belongs to adapters.
...
Consume this ComponentSpec via `@celestial-ui/core/specs/password-input`. Do not redefine behavior in React/Vue.
