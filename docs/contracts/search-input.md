...
Search query input with clear affordance.

## Scope

Phase 1 (P0) contract for `search-input`. Framework-agnostic semantics only; rendering belongs to adapters.
...
Consume this ComponentSpec via `@celestial-ui/core/specs/search-input`. Do not redefine behavior in React/Vue.
