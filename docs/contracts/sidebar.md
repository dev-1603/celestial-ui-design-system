...
Persistent or collapsible application sidebar.

## Scope

Phase 1 (P1) contract for `sidebar`. Framework-agnostic semantics only; rendering belongs to adapters.
...
Consume this ComponentSpec via `@celestial-ui/core/specs/sidebar`. Do not redefine behavior in React/Vue.
