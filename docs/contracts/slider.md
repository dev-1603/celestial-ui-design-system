...
Numeric value selection along a track.

## Scope

Phase 1 (P1) contract for `slider`. Framework-agnostic semantics only; rendering belongs to adapters.
...
Consume this ComponentSpec via `@celestial-ui/core/specs/slider`. Do not redefine behavior in React/Vue.
