...
Flex stack layout for vertical or horizontal flow.

## Scope

Phase 1 (P0) contract for `stack`. Framework-agnostic semantics only; rendering belongs to adapters.
...
Consume this ComponentSpec via `@celestial-ui/core/specs/stack`. Do not redefine behavior in React/Vue.
