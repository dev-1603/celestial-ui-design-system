...
Sequential step navigation control.

## Scope

Phase 1 (P1) contract for `stepper`. Framework-agnostic semantics only; rendering belongs to adapters.
...
Consume this ComponentSpec via `@celestial-ui/core/specs/stepper`. Do not redefine behavior in React/Vue.
