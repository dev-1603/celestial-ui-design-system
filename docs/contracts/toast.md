...
Phase 1 (P0) contract for `toast`. Framework-agnostic semantics only; rendering belongs to adapters.
...
Consume this ComponentSpec via `@celestial-ui/core/specs/toast`. Do not redefine behavior in React/Vue.
