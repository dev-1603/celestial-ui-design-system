...
Phase 1 (P1) contract for `toolbar`. Framework-agnostic semantics only; rendering belongs to adapters.
...
Consume this ComponentSpec via `@celestial-ui/core/specs/toolbar`. Do not redefine behavior in React/Vue.
