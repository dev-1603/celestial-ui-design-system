...
Brief descriptive label on hover or focus.

## Scope

Phase 1 (P0) contract for `tooltip`. Framework-agnostic semantics only; rendering belongs to adapters.
...
Consume this ComponentSpec via `@celestial-ui/core/specs/tooltip`. Do not redefine behavior in React/Vue.
